...
import NavMenuTablet from './components/NavMenuTablet'
...
const planetsObj = [
  {
    ...
    "classdiv": 'bg-lightgray',
    "imgstyle" : 'w-[111px] h-[111px] mt-[1rem] tablet:w-[184px] tablet:h-[184px] desktop:w-[290px] desktop:h-[290px] ',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-cyan",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-cyan',
    "tabletButtongroup": 'bg-cyan',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-cyan',
    "overview": {
    ...
    "images": {
      ...
      "sourceIcon" : './assets/icon-source.svg',
    }, 
  ...
  },
  {
    ...
    "classdiv": 'bg-mustard',
    "name": "Venus",
    "imgstyle" : 'w-[154px] h-[154px] mt-[1rem] tablet:w-[253px] tablet:h-[253px] desktop:w-[400px] desktop:h-[400px]',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-mustard",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-mustard',
    "tabletButtongroup": 'bg-mustard',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-mustard',
    "overview": {
  ...
  },
  {
    ...
    "classtext": 'text-white',
    "classdiv": 'bg-purple',
    "imgstyle" : 'w-[173px] h-[173px] mt-[1rem] tablet:w-[285px] tablet:h-[285px] desktop:w-[450px] desktop:h-[450px]',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-purple",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-purple',
    "tabletButtongroup": 'bg-purple',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-purple',
    "overview": {
  ...
  },
  {
    ...
    "classtext": 'text-white',
    "classdiv": 'bg-orange',
    "imgstyle" : 'w-[129px] h-[129px] mt-[1rem] tablet:w-[213px] tablet:h-[213px] desktop:w-[336px] desktop:h-[336px]',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-orange",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item   text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-orange',
    "tabletButtongroup": 'bg-orange',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-orange',
    "overview": {
  ...
  },
  {
    ...
    "classtext": 'text-white',
    "classdiv": 'bg-jup',
    "imgstyle" : 'w-[224px] h-[224px] mt-[1rem] tablet:w-[369px] tablet:h-[369px] desktop:w-[582px] desktop:h-[582px]',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-red",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-red',
    "tabletButtongroup": 'bg-red',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-red',
    "overview": {
  ...
  },
  {
    ...
    "classtext": 'text-white',
    "classdiv": 'bg-mustard',
    "imgstyle" : 'w-[256px] h-[256px] mt-[1rem] tablet:w-[422px] tablet:h-[422px] desktop:w-[666px] desktop:h-[666px]',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-darkorange",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-darkorange',
    "tabletButtongroup": 'bg-darkorange',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-darkorange',
    "overview": {
  ...
  },
  {
    ...
    "name": "Uranus",
    "classtext": 'text-white',
    "classdiv": 'bg-lightcyan',
    "imgstyle" : 'w-[176px] h-[176px] mt-[1rem] tablet:w-[290px] tablet:h-[290px] desktop:w-[458px] desktop:h-[458px]',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-lightcyan",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-lightcyan',
    "tabletButtongroup": 'bg-lightcyan',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-lightcyan',
    "overview": {
  ...
  },
  {
    ...
    "imgstyle" : 'w-[173px] h-[173px] mt-[1rem] tablet:w-[285px] tablet:h-[285px] desktop:w-[450px] desktop:h-[450px]',
    "mobileButtonGroup" : 'font-spartabold text-center tracking-[1.9px] leading-[10px] text-[0.5625rem] text-lightgray bold border-b-4 hover:text-white',
    "mobileButtonGroupActive" : "text-white border-blue",
    "navMenuTablet" : 'hover:text-white border-b-2 list-item   text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuTabletActive" : 'text-white border-blue',
    "tabletButtongroup": 'bg-blue',
    "navMenuDesktop" : 'hover:text-white border-t-4 list-item  text-center text-lightgray uppercase text-[0.6875rem] tracking-[1px] leading-[25px] font-spartabold bold',
    "navMenuDesktopActive": 'text-white border-blue',
    "overview": {
  ...
  return (
    <div className={`wrapper bg-darkblue w-full min-h-screen `} >
     ...
     <NavMenuTablet planetsObj={planetsObj} setCurrentId={setCurrentId} currentId={currentId}/>
      <main>
        <PlanetPage planetsObj={planetsObj} currentId={currentId} setCurrentId={setCurrentId}/>
      </main>
    </div> 
  );
}
